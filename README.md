运行gemma大语言模型加多模态，自己安装Open WebUI
api-key gemma

.\llama-server.exe -m gemma-3-4b-it-Q8_0.gguf --mmproj mmproj-model-f16.gguf -n 2048  -t 8 -e -ngl 99 -c 2500 --temp 0 --api-key gemma --port 9999
